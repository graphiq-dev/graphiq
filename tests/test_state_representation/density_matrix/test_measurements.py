import src.backends.state_representation_conversion as rep_con
...
def test_y_measurement():
    ...
    rho = DensityMatrix(rep_con.graph_to_density(graph1))
    ...
    graph_adj = rep_con.density_to_graph(rho.data)
...
def test_x_measurement():
    ...
    rho2 = DensityMatrix(rep_con.graph_to_density(graph2))
