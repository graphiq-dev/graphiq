...
@pytest.mark.parametrize(
    "ghz3_state_circuit", [circ.ghz3_state_circuit, equiv_circ.ghz3_state_circuit]
)
...
@pytest.mark.parametrize(
    "ghz4_state_circuit", [circ.ghz4_state_circuit, equiv_circ.ghz4_state_circuit]
)
...
@pytest.mark.parametrize(
    ...
    [circ.linear_cluster_3qubit_circuit, equiv_circ.linear_cluster_3qubit_circuit],
)
...
@pytest.mark.parametrize(
    ...
    [circ.linear_cluster_4qubit_circuit, equiv_circ.linear_cluster_4qubit_circuit],
)
