from src.solvers.rule_based_random_solver import *
...
def test_assignment():
    n_photon = 10
    n_emitter = 5
    print(get_emission_assignment(n_photon, n_emitter, 0))
    print(get_measurement_assignment(n_photon, n_emitter, 0))
