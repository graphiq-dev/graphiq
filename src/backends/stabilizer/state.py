...
class Stabilizer(StateRepresentationBase):
    def __init__(self, data, *args, **kwargs):
        ...
        super().__init__(data, *args, **kwargs)
        if isinstance(data, int):
            self._mixture = [(1.0, CliffordTableau(data)),]
        elif isinstance(data, CliffordTableau):
            self._mixture = [(1.0, data),]
        else:
            raise TypeError(
                f"Cannot initialize the stabilizer representation with datatype: {type(data)}"
            )
    ...
    def mixture(self, value):
        if isinstance(value, list):
            ...
            raise TypeError("Must use a list of CliffordTableau for the mixed stabilizer")
    ...
    def apply_hadamard(self, qubit_position):
        ...
        :rtype: None
        """
        self._mixture = [(pi, transform.hadamard_gate(tableau_i, qubit_position)) for (pi, tableau_i) in self._mixture]
    ...
    def apply_cnot(self, control, target):
        ...
        :rtype: None
        """
        self._mixture = [(pi, transform.cnot_gate(tableau_i, control, target)) for (pi, tableau_i) in self._mixture]
    ...
    def apply_cz(self, control, target):
        ...
        :rtype: None
        """
        self._mixture = [(pi, transform.control_z_gate(tableau_i, control, target)) for (pi, tableau_i) in self._mixture]
    ...
    def apply_phase(self, qubit_position):
        ...
        :rtype: None
        """
        self._mixture = [(pi, transform.phase_gate(tableau_i, qubit_position)) for (pi, tableau_i) in self._mixture]
    ...
    def apply_sigmax(self, qubit_position):
        ...
        :rtype: None
        """
        self._mixture = [(pi, transform.x_gate(tableau_i, qubit_position)) for (pi, tableau_i) in self._mixture]
    ...
    def apply_sigmay(self, qubit_position):
        ...
        :rtype: None
        """
        self._mixture = [(pi, transform.y_gate(tableau_i, qubit_position)) for (pi, tableau_i) in self._mixture]
    ...
    def apply_sigmaz(self, qubit_position):
        ...
        :rtype: None
        """
        self._mixture = [(pi, transform.z_gate(tableau_i, qubit_position)) for (pi, tableau_i) in self._mixture]
    ...
    def reset_qubit(self, qubit_position, measurement_determinism="probabilistic"):
        ...
        :rtype: None
        """
        self._mixture = [(pi, sfc.reset_z(tableau_i, qubit_position, 0, measurement_determinism)) for (pi, tableau_i) in self._mixture]
