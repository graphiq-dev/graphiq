...
def test_initializing_dm_1(n):
    data = dmnp.eye(2**n)
    state = QuantumState(data, representation="dm")
...
def test_initializing_dm_2():
    ...
    with pytest.raises(TypeError):
        QuantumState(data, representation="dm")


def test_initializing_graph_1():
    data = 5
    state = QuantumState(data, representation="graph")
...
def test_initializing_stabilizer_1():
    ...
    n = 130
    state = QuantumState(n, representation="stab")
...
def test_initializing_stabilizer_2():
    ...
    n = 130
    state = QuantumState(CliffordTableau(n), representation="stab")
    assert state.rep_data.n_qubits == n
