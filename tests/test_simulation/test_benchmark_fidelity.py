...
@pytest.mark.parametrize("ghz4_state_circuit", [og_circ.ghz4_state_circuit,
...
@pytest.mark.parametrize("linear_cluster_3qubit_circuit", [og_circ.linear_cluster_3qubit_circuit,
