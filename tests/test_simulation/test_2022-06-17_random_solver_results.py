...
def ghz3_0():
    ...
    dag.add(ops.MeasurementCNOTandReset(control=0, control_type='e',
...
def ghz3_1():
    ...
    dag.add(ops.CNOT(control=0, control_type='e', target=2, target_type='p'))
    dag.add(ops.Hadamard(register=2, reg_type='p'))
    dag.add(ops.SingleQubitGateWrapper([ops.Hadamard, ops.Phase, ops.SigmaZ], register=0, reg_type='e'))
    dag.add(ops.MeasurementCNOTandReset(control=0, control_type='e',
                                        target=2, target_type='p',
                                        c_register=0))
    return dag
