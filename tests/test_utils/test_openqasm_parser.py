...
# TODO: implement this testings
#  note: Use @pytest.mark.parametrize to enable multiple case testing


def test_parser_init():
    pass

def test_parser_parse_qreg():
    pass

def test_parser_parse_creg():
    pass

def test_parser_parse_gate():
    pass
